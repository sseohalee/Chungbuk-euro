...
def get_data_from_csv():
    data_restaurant = pd.read_csv("C:\projects\\trip\mytrip\static\data\\fin.csv", encoding='cp949',thousands = ',', index_col=0)
    data_trip = pd.read_csv("C:\projects\\trip\mytrip\static\data\\trip.csv", encoding='cp949',index_col=0)
...
def cafe(region, region_dong, cate):
    #데이터 로딩
    ...
    data_restaurant = data_restaurant[(data_restaurant['cate_1']=='커피점/카페')|(data_restaurant['naver_store_type']=='카페,디저트')]
    ...
    return best_restaurant.index[0]
